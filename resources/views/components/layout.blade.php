...
<section class="px-6 py-8">
    <nav class="flex  justify-between items-center">
        <div style="height:16px; width:165px ">
            <a href="/">
        ...
        <article
            ...
            <div class="py-6 px-5 lg:flex">
                <div class="flex-1 lg:mr-8">
                    <img src="/images/illustration-8.jpg" alt="Blog Post illustration" class="rounded-xl">
                </div>
                ...
                <div class="flex-1 flex flex-col justify-between">
                    ...
                    <footer class="flex justify-between items-center mt-8">
                        <div class="flex items-center text-sm">
                            <img width="76" height="83" src="/images/cat_avatar.png" alt="Lary avatar">
                            <div class="ml-3">
                                <h5 class="font-bold">Kitty</h5>
                                <h6>Mascot at </h6>
                            </div>
                        </div>
